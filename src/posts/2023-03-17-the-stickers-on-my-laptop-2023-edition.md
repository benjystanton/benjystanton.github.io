...
Read on for a description of each sticker, with links to their origin stories or creators' web sites. Description go roughly left to right, top to bottom.
...
7. **The problem with London is it is so far from everywhere** – Blue illustration of the United Kingdom on pink background. From [Ian Ames](https://ames.world/).
